var _Field_instances, _a, _Field_isField, _Field_toConst, _Field_toVar, _Field_compare, _Field_checkBitLength;
...
export { Field, FieldType, FieldVar, FieldConst, isField };
...
class Field {
    ...
    toConstant() {
        ...
        return new Field(FieldVar.constant(value));
    }
    /**
...
_a = Field, _Field_instances = new WeakSet(), _Field_isField = function _Field_isField(x) {
    return x instanceof Field || x instanceof SnarkyFieldConstructor;
