...
var import_plonk_wasm = __toESM(require("././_node_bindings/plonk_wasm.cjs"), 1);
...
var { Field, Bool, Snarky, Poseidon, Group, Scalar, Ledger, Pickles, Test } = proxyClasses(getSnarky, isItReady, snarky_class_spec_default);
...
function prefixToField(Field6, prefix) {
  let fieldSize = Field6.sizeInBytes();
  if (prefix.length >= fieldSize)
    throw Error("prefix too long");
  let stringBytes = stringToBytes(prefix);
  return Field6.fromBytes(stringBytes.concat(Array(fieldSize - stringBytes.length).fill(0)));
}
...
var SnarkyFieldConstructor = Field(1).constructor;
function constToBigint(x) {
  return Field2.fromBytes([...x]);
}
function constFromBigint(x) {
  return Uint8Array.from(Field2.toBytes(x));
}
var FieldConst = {
...
var Field4 = class {
  ...
  constructor(x) {
    ...
    if ((0, import_tslib.__classPrivateFieldGet)(Field4, _a, "m", _Field_isField).call(Field4, x)) {
      this.value = x.value;
      return;
    }
    if (Array.isArray(x)) {
    ...
    this.value = FieldVar.constant(Field2(x));
  }
  static from(x) {
    if ((0, import_tslib.__classPrivateFieldGet)(Field4, _a, "m", _Field_isField).call(Field4, x))
      return x;
  ...
  toConstant() {
    ...
    return new Field4(FieldVar.constant(value));
  }
  /**
  ...
  assertEquals(y, message) {
    try {
      ...
      Snarky.field.assertEqual(this.value, (0, import_tslib.__classPrivateFieldGet)(Field4, _a, "m", _Field_toVar).call(Field4, y));
    } catch (err) {
  ...
  add(y) {
    if (this.isConstant() && isConstant(y)) {
      return new Field4(Field2.add(this.toBigInt(), toFp(y)));
    }
    let z = Snarky.field.add(this.value, (0, import_tslib.__classPrivateFieldGet)(Field4, _a, "m", _Field_toVar).call(Field4, y));
    return new Field4(z);
  }
  /**
  ...
  neg() {
    if (this.isConstant()) {
      return new Field4(Field2.negate(this.toBigInt()));
    }
   ...
   */
  sub(y) {
    return this.add(Field4.from(y).neg());
  }
  /**
  ...
  mul(y) {
    if (this.isConstant() && isConstant(y)) {
      return new Field4(Field2.mul(this.toBigInt(), toFp(y)));
    }
    if (isConstant(y)) {
      let z2 = Snarky.field.scale((0, import_tslib.__classPrivateFieldGet)(Field4, _a, "m", _Field_toConst).call(Field4, y), this.value);
      return new Field4(z2);
    }
    if (this.isConstant()) {
      let z2 = Snarky.field.scale(this.value[1], y.value);
      return new Field4(z2);
    }
    let z = Snarky.existsVar(() => FieldConst.fromBigint(Field2.mul(this.toBigInt(), toFp(y))));
  ...
  inv() {
    if (this.isConstant()) {
      let z2 = Field2.inverse(this.toBigInt());
      if (z2 === void 0)
        throw Error("Field.inv(): Division by zero");
      return new Field4(z2);
    }
    let z = Snarky.existsVar(() => {
      let z2 = Field2.inverse(this.toBigInt()) ?? 0n;
   ...
   */
  div(y) {
    return this.mul(Field4.from(y).inv());
  }
  /**
  ...
  square() {
    if (this.isConstant()) {
      return new Field4(Field2.square(this.toBigInt()));
    }
    let z = Snarky.existsVar(() => FieldConst.fromBigint(Field2.square(this.toBigInt())));
  ...
  sqrt() {
    if (this.isConstant()) {
      let z2 = Field2.sqrt(this.toBigInt());
      if (z2 === void 0)
        throw Error(`Field.sqrt(): input ${this} has no square root in the field.`);
      return new Field4(z2);
    }
    let z = Snarky.existsVar(() => {
      let z2 = Field2.sqrt(this.toBigInt()) ?? 0n;
      return FieldConst.fromBigint(z2);
    });
  ...
  isZero() {
    ...
    let [, b2, z] = Snarky.exists(2, () => {
      let x = this.toBigInt();
      let z2 = Field2.inverse(x) ?? 0n;
      let b3 = Field2.sub(1n, Field2.mul(z2, x));
    ...
    return Bool.Unsafe.ofField(new Field4(b2));
  }
  /**
  ...
  lessThan(y) {
    ...
    return (0, import_tslib.__classPrivateFieldGet)(this, _Field_instances, "m", _Field_compare).call(this, (0, import_tslib.__classPrivateFieldGet)(Field4, _a, "m", _Field_toVar).call(Field4, y)).less;
  }
  /**
  ...
  lessThanOrEqual(y) {
    ...
    return (0, import_tslib.__classPrivateFieldGet)(this, _Field_instances, "m", _Field_compare).call(this, (0, import_tslib.__classPrivateFieldGet)(Field4, _a, "m", _Field_toVar).call(Field4, y)).lessOrEqual;
  }
  /**
  ...
  assertLessThan(y, message) {
    try {
      ...
      let { less } = (0, import_tslib.__classPrivateFieldGet)(this, _Field_instances, "m", _Field_compare).call(this, (0, import_tslib.__classPrivateFieldGet)(Field4, _a, "m", _Field_toVar).call(Field4, y));
      less.assertTrue();
    } catch (err) {
      throw withMessage(err, message);
    }
  ...
  assertLessThanOrEqual(y, message) {
    try {
      ...
      let { lessOrEqual } = (0, import_tslib.__classPrivateFieldGet)(this, _Field_instances, "m", _Field_compare).call(this, (0, import_tslib.__classPrivateFieldGet)(Field4, _a, "m", _Field_toVar).call(Field4, y));
  ...
  assertGreaterThan(y, message) {
    Field4.from(y).assertLessThan(this, message);
  }
  /**
  ...
  assertGreaterThanOrEqual(y, message) {
    Field4.from(y).assertLessThanOrEqual(this, message);
  }
  /**
  ...
  toBits(length) {
    if (length !== void 0)
      (0, import_tslib.__classPrivateFieldGet)(Field4, _a, "m", _Field_checkBitLength).call(Field4, "Field.toBits()", length);
    if (this.isConstant()) {
      let bits3 = Field2.toBits(this.toBigInt());
      if (length !== void 0) {
        if (bits3.slice(length).some((bit) => bit))
          throw Error(`Field.toBits(): ${this} does not fit in ${length} bits`);
        return bits3.slice(0, length).map(Bool);
      }
      return bits3.map(Bool);
    }
    let [, ...bits2] = Snarky.field.toBits(length ?? Field2.sizeInBits, this.value);
    return bits2.map((b2) => Bool.Unsafe.ofField(new Field4(b2)));
  }
  /**
  ...
  static fromBits(bits2) {
    ...
    (0, import_tslib.__classPrivateFieldGet)(Field4, _a, "m", _Field_checkBitLength).call(Field4, "Field.fromBits()", length);
    if (bits2.every((b2) => typeof b2 === "boolean" || b2.toField().isConstant())) {
      let bits_ = bits2.map((b2) => typeof b2 === "boolean" ? b2 : b2.toBoolean()).concat(Array(Field2.sizeInBits - length).fill(false));
      return new Field4(Field2.fromBits(bits_));
    }
  ...
  rangeCheckHelper(length) {
    (0, import_tslib.__classPrivateFieldGet)(Field4, _a, "m", _Field_checkBitLength).call(Field4, "Field.rangeCheckHelper()", length);
    if (length % 16 !== 0)
      throw Error("Field.rangeCheckHelper(): `length` has to be a multiple of 16.");
    let lengthDiv16 = length / 16;
    if (this.isConstant()) {
      let bits2 = Field2.toBits(this.toBigInt()).slice(0, length).concat(Array(Field2.sizeInBits - length).fill(false));
      return new Field4(Field2.fromBits(bits2));
    }
   ...
   */
  static random() {
    return new Field4(Field2.random());
  }
  // internal stuff
  // Provable<Field>
  /**
  ...
  static fromJSON(json) {
    return new Field4(Field2.fromJSON(json));
  }
  /**
   * **Warning**: This function is mainly for internal use. Normally it is not intended to be used by a zkApp developer.
   *
   ...
   */
  static sizeInBytes() {
    return Field2.sizeInBytes();
  }
};
_a = Field4, _Field_instances = /* @__PURE__ */ new WeakSet(), _Field_isField = function _Field_isField2(x) {
  return x instanceof Field4 || x instanceof SnarkyFieldConstructor;
}, _Field_toConst = function _Field_toConst2(x) {
  if ((0, import_tslib.__classPrivateFieldGet)(Field4, _a, "m", _Field_isField).call(Field4, x))
    return x.value[1];
  return FieldConst.fromBigint(Field2(x));
}, _Field_toVar = function _Field_toVar2(x) {
  if ((0, import_tslib.__classPrivateFieldGet)(Field4, _a, "m", _Field_isField).call(Field4, x))
    return x.value;
  return FieldVar.constant(Field2(x));
}, _Field_compare = function _Field_compare2(y) {
  let maxLength = Field2.sizeInBits - 2;
  asProver(() => {
    let actualLength = Math.max(this.toBigInt().toString(2).length, new Field4(y).toBigInt().toString(2).length);
  ...
  return {
    less: Bool.Unsafe.ofField(new Field4(less)),
    lessOrEqual: Bool.Unsafe.ofField(new Field4(lessOrEqual))
  };
}, _Field_checkBitLength = function _Field_checkBitLength2(name, length) {
  if (length > Field2.sizeInBits)
    throw Error(`${name}: bit length must be ${Field2.sizeInBits} or less, got ${length}`);
  if (length <= 0)
    throw Error(`${name}: bit length must be positive, got ${length}`);
};
Field4.ORDER = Field2.modulus;
var FieldBinable = defineBinable({
  ...
  readBytes(bytes, offset) {
    ...
    return [
      Object.assign(Object.create(new Field4(1).constructor.prototype), {
        value: [0, uint8array]
      }),
      offset + 32
    ];
...
function customEncoding(Field6, versionByte, versionNumber) {
  let customField = versionNumber !== void 0 ? withVersionNumber(Field6, versionNumber) : Field6;
...
function fieldEncodings(Field6) {
  const TokenId4 = customEncoding(Field6, versionBytes.tokenIdKey);
  const ReceiptChainHash3 = customEncoding(Field6, versionBytes.receiptChainHash, RECEIPT_CHAIN_HASH_VERSION);
  const LedgerHash2 = customEncoding(Field6, versionBytes.ledgerHash, LEDGER_HASH_VERSION);
  const EpochSeed2 = customEncoding(Field6, versionBytes.epochSeed, EPOCH_SEED_VERSION);
  const StateHash3 = customEncoding(Field6, versionBytes.stateHash, STATE_HASH_VERSION);
...
var Field5 = toFunctionConstructor(Field4);
...
Scalar.toFieldsCompressed = function(s) {
  let isConstant2 = s.toFields().every((x2) => x2.isConstant());
  let constantValue = s.constantValue;
  if (!isConstant2 || constantValue === void 0)
...
function equalImplicit(x, y) {
  ...
  return xs.map((x2, i2) => x2.equals(ys[i2])).reduce(Bool.and);
}
...
Provable.if(bool, MyType, x, y)`);
  if (type !== y.constructor && !(isField(x) && isField(y))) {
...
function switch_(mask, type, values) {
  ...
  let fields = Array(size).fill(Field5(0));
...
function getBlindingValue() {
  if (!memoizationContext.has())
    return Field5.random();
  let context = memoizationContext.get();
  if (context.blindingValue === void 0) {
    context.blindingValue = Field5.random();
  }
...
function cloneCircuitValue(obj) {
  ...
  if (["AccountUpdate"].includes(obj.constructor?.name)) {
...
function createHashHelpers(Field6, Hash3) {
  function salt2(prefix) {
    return Hash3.update(Hash3.initialState(), [prefixToField(Field6, prefix)]);
  }
...
var Poseidon2 = {
  ...
  hashToGroup(input) {
    let isChecked = !input.every((x2) => x2.isConstant());
    let { x, y } = Poseidon.hashToGroup(input, isChecked);
    let x0 = Provable.witness(Field5, () => {
  ...
  update(state3, input) {
    let isChecked = !(state3.every((x) => x.isConstant()) && input.every((x) => x.isConstant()));
    return Poseidon.update(state3, input, isChecked);
  },
  initialState() {
...
var Hash = createHashHelpers(Field5, Poseidon2);
...
function prefixToField2(prefix) {
  ...
  return Field5.fromBits(bits2);
}
function packToFields({ fields = [], packed = [] }) {
  if (packed.length === 0)
    return fields;
  let packedBits = [];
  let currentPackedField = Field5(0);
  let currentSize = 0;
  for (let [field, size] of packed) {
    currentSize += size;
    if (currentSize < 255) {
      currentPackedField = currentPackedField.mul(Field5(1n << BigInt(size))).add(field);
    } else {
...
(0, import_tslib2.__decorate)([
  prop,
  (0, import_tslib2.__metadata)("design:type", Scalar)
...
var PublicKey2 = class extends CircuitValue {
   ...
   */
  static empty() {
    return PublicKey2.from({ x: Field5(0), isOdd: Bool(false) });
  }
  /**
...
(0, import_tslib2.__decorate)([
  prop,
  (0, import_tslib2.__metadata)("design:type", Field5)
], PublicKey2.prototype, "x", void 0);
(0, import_tslib2.__decorate)([
  prop,
  (0, import_tslib2.__metadata)("design:type", Bool)
...
var Circuit = class {
  ...
  static prove(privateInput, publicInput, keypair) {
    ...
    return prettifyStacktracePromise(withThreadPool(async () => {
      let proof = Snarky.circuit.prove(main, publicInputSize, publicInputFields, keypair.value);
  ...
  static verify(publicInput, verificationKey, proof) {
    let publicInputFields = this._main.publicInputType.toFields(publicInput);
    return prettifyStacktracePromise(withThreadPool(async () => Snarky.circuit.verify(publicInputFields, proof.value, verificationKey.value)));
  }
};
...
var UInt642 = class extends CircuitValue {
   ...
   */
  static get zero() {
    return new UInt642(Field5(0));
  }
  /**
   * Static method to create a {@link UInt64} with value `1`.
   */
  static get one() {
    return new UInt642(Field5(1));
  }
  /**
  ...
  static from(x) {
    if (x instanceof UInt642 || x instanceof UInt322)
      x = x.value;
    return new this(this.checkConstant(Field5(x)));
  }
  /**
   * Creates a {@link UInt64} with a value of 18,446,744,073,709,551,615.
   */
  static MAXINT() {
    return new UInt642(Field5((1n << 64n) - 1n));
  }
  /**
  ...
  divMod(y) {
    ...
    if (this.value.isConstant() && y_.isConstant()) {
      ...
      let r2 = xn - q4 * yn;
      return {
        quotient: new UInt642(Field5(q4)),
        rest: new UInt642(Field5(r2))
      };
    }
    y_ = y_.seal();
    let q3 = Provable.witness(Field5, () => new Field5(x.toBigInt() / y_.toBigInt()));
...
(0, import_tslib3.__decorate)([
  prop,
  (0, import_tslib3.__metadata)("design:type", Field5)
...
var UInt322 = class extends CircuitValue {
   ...
   */
  static get zero() {
    return new UInt322(Field5(0));
  }
  /**
   * Static method to create a {@link UInt32} with value `0`.
   */
  static get one() {
    return new UInt322(Field5(1));
  }
  /**
   ...
   */
  static MAXINT() {
    return new UInt322(Field5((1n << 32n) - 1n));
  }
  /**
   * Integer division with remainder.
   *
  ...
  divMod(y) {
    ...
    if (x.isConstant() && y_.isConstant()) {
      ...
      let r2 = xn - q4 * yn;
      return {
        quotient: new UInt322(new Field5(q4.toString())),
        rest: new UInt322(new Field5(r2.toString()))
      };
    }
    y_ = y_.seal();
    let q3 = Provable.witness(Field5, () => new Field5(x.toBigInt() / y_.toBigInt()));
...
var Sign3 = class extends CircuitValue {
  static get one() {
    return new Sign3(Field5(1));
  }
  static get minusOne() {
    return new Sign3(Field5(-1));
  }
  static check(x) {
    x.value.square().assertEquals(Field5(1));
  }
  static emptyValue() {
    return Sign3.one;
  }
  ...
  static fromJSON(x) {
    return x === "Positive" ? new Sign3(Field5(1)) : new Sign3(Field5(-1));
  }
  neg() {
  ...
  isPositive() {
    return this.value.equals(Field5(1));
  }
  toString() {
    return this.value.toString();
  }
...
var Int64 = class extends CircuitValue {
  ...
  static fromFieldUnchecked(x) {
    ...
    let isValidNegative = Field5.ORDER - xBigInt < TWO64;
    if (!isValidPositive && !isValidNegative)
      throw Error(`Int64: Expected a value between (-2^64, 2^64), got ${x}`);
    let magnitude = Field5(isValidPositive ? x.toString() : x.neg().toString());
  ...
  static from(x) {
    ...
    return Int64.fromFieldUnchecked(Field5(x));
  }
  /**
...
function createEvents({ Field: Field6, Poseidon: Poseidon4 }) {
  function initialState() {
    return [Field6(0), Field6(0), Field6(0)];
  }
  function salt2(prefix) {
    return Poseidon4.update(initialState(), [prefixToField(Field6, prefix)]);
  }
  function hashWithPrefix3(prefix, input) {
    let init = salt2(prefix);
  ...
  const EventsProvable = {
    ...
    ...dataAsHash({
      ...
      toJSON(data) {
        return data.map((row) => row.map((e) => Field6.toJSON(e)));
      },
      fromJSON(json) {
        let data = json.map((row) => row.map((e) => Field6.fromJSON(e)));
...
function derivedLeafTypes({ Field: Field6, Bool: Bool4, Hash: Hash3, packToFields: packToFields3 }) {
  let provable3 = createProvable();
  const Encoding = fieldEncodings(Field6);
  const defaultTokenId = 1;
  const TokenId4 = {
    ...provable3(Field6),
    emptyValue() {
      return Field6(defaultTokenId);
    },
    toJSON(x) {
  ...
  const TokenSymbol3 = {
    ...provable3({ field: Field6, symbol: String }),
    toInput({ field }) {
      return { packed: [[field, 48]] };
    },
    toJSON({ symbol }) {
    ...
    fromJSON(symbol) {
      ...
      if (bytesLength > tokenSymbolLength)
        throw Error(`Token symbol ${symbol} should be a maximum of 6 bytes, but is ${bytesLength}`);
      return { symbol, field: prefixToField(Field6, symbol) };
    }
  };
  const AuthRequired2 = {
  ...
  function hashZkappUri(uri) {
    ...
    bits2.push(true);
    let input = { packed: bits2.map((b2) => [Field6(Number(b2)), 1]) };
    let packed = packToFields3(input);
    return Hash3.hashWithPrefix(prefixes.zkappUri, packed);
  }
  const ZkappUri2 = dataAsHash({
    emptyValue() {
      let hash2 = Hash3.hashWithPrefix(prefixes.zkappUri, [Field6(0), Field6(0)]);
      return { data: "", hash: hash2 };
    },
    toJSON(data) {
      return data;
...
var { TokenId, StateHash, TokenSymbol: TokenSymbol2, AuthRequired, ZkappUri } = derivedLeafTypes({ Field: Field5, Bool, Hash, packToFields });
var { Events, Actions } = createEvents({ Field: Field5, Poseidon: Poseidon2 });
var ActionState = {
  ...provable2(Field5),
...
function bytesToFields(bytes) {
  ...
  for (let byte of bytes) {
    ...
    bitPosition += 8n;
    if (bitPosition === 248n) {
      fields.push(Field5(currentBigInt.toString()));
      currentBigInt = 0n;
      bitPosition = 0n;
    }
  }
...
var baseMap = { UInt64: UInt642, UInt32: UInt322, Field: Field5, Bool, PublicKey: PublicKey2 };
...
function timestampToGlobalSlot(timestamp, message) {
  ...
  rest.value.assertEquals(Field5(0), message);
...
var Proof2 = class {
  ...
  static fromJSON({ maxProofsVerified, proof: proofString, publicInput: publicInputJson, publicOutput: publicOutputJson }) {
    ...
    let publicInput = type.input.fromFields(publicInputJson.map(Field5));
    let publicOutput = type.output.fromFields(publicOutputJson.map(Field5));
    return new this({
      publicInput,
      publicOutput,
      proof,
...
async function verify(proof, verificationKey) {
  ...
  if (typeof proof.proof === "string") {
    ...
    statement = {
      input: proof.publicInput.map(Field5),
      output: proof.publicOutput.map(Field5)
    };
  } else {
...
function ZkProgram(config) {
  ...
  async function compile() {
    let { provers: provers2, verify: verify3, verificationKey } = await compileProgram(publicInputType, publicOutputType, methodIntfs, methodFunctions, selfTag);
  ...
  function digest() {
    ...
    let hash2 = Poseidon.hash(Object.values(methodData).map((d) => Field5(BigInt("0x" + d.digest))), false);
...
async function compileProgram(publicInputType, publicOutputType, methodIntfs, methods, proofSystemTag) {
  ...
  let { verificationKey, provers, verify: verify2, tag } = await prettifyStacktracePromise(withThreadPool(async () => {
    let result;
    ...
    let { getVerificationKeyArtifact, provers: provers2, verify: verify3, tag: tag2 } = result;
    CompiledTag.store(proofSystemTag, tag2);
    let verificationKey2 = getVerificationKeyArtifact();
    return { verificationKey: verificationKey2, provers: provers2, verify: verify3, tag: tag2 };
  }));
  ...
  let wrappedVerify = async function picklesVerify(statement, proof) {
    return prettifyStacktracePromise(withThreadPool(() => verify2(statement, proof)));
  };
  return {
    verificationKey,
    ...
    for (let i2 = 0; i2 < allArgs.length; i2++) {
      ...
      if (arg.type === "witness") {
        ...
        finalArgs[i2] = Provable.witness(type, () => {
          return argsWithoutPublicInput?.[i2] ?? emptyValue2(type);
        });
        ...
        let proof_ = argsWithoutPublicInput?.[i2] ?? {
          proof: void 0,
          publicInput: emptyValue2(type.input),
          publicOutput: emptyValue2(type.output)
        };
        ...
        previousStatements.push({
          input: type.input.toFields(publicInput2),
          output: type.output.toFields(publicOutput2)
        });
...
function synthesizeMethodArguments({ allArgs, proofArgs, witnessArgs }, asVariables = false) {
  let args = [];
  let empty = asVariables ? emptyWitness : emptyValue2;
...
function emptyValue2(type) {
  return type.fromFields(Array(type.sizeInFields()).fill(Field5(0)), type.toAuxiliary());
}
function emptyWitness(type) {
  return Provable.witness(type, () => emptyValue2(type));
}
...
ZkProgram.Proof = function(program) {
  var _a2;
  return _a2 = class ZkProgramProof extends Proof2 {
...
var { TokenId: TokenId2, ReceiptChainHash: ReceiptChainHash2, EpochSeed, LedgerHash, StateHash: StateHash2 } = fieldEncodings(Field5);
...
function parseFetchedAccount({ publicKey, nonce, zkappState, balance, permissions, timing: { cliffAmount, cliffTime, initialMinimumBalance, vestingIncrement, vestingPeriod }, delegateAccount, receiptChainHash, actionState, token, tokenSymbol, verificationKey, provedState, zkappUri }) {
  ...
  let partialAccount = {
    ...
    zkapp: hasZkapp ? {
      appState: (zkappState && zkappState.map(Field5)) ?? void 0,
      verificationKey: (verificationKey && {
        data: verificationKey.verificationKey,
        hash: Field5(verificationKey.hash)
      }) ?? void 0,
      zkappVersion: void 0,
      actionState: (actionState && actionState.map(Field5)) ?? void 0,
...
async function fetchAccountInternal(accountInfo, graphqlEndpoint = networkConfig.minaEndpoint, config) {
  ...
  let [response, error] = await makeGraphqlRequest(accountQuery(publicKey, tokenId ?? TokenId3.toBase58(TokenId3.default)), graphqlEndpoint, networkConfig.minaFallbackEndpoints, config);
  if (error !== void 0)
...
async function fetchEvents(accountInfo, graphqlEndpoint = networkConfig.archiveEndpoint, filterOptions = {}) {
  ...
  const { publicKey, tokenId } = accountInfo;
  let [response, error] = await makeGraphqlRequest(getEventsQuery(publicKey, tokenId ?? TokenId3.toBase58(TokenId3.default), filterOptions), graphqlEndpoint, networkConfig.archiveFallbackEndpoints);
  if (error)
    throw Error(error.statusText);
...
async function fetchActions(accountInfo, graphqlEndpoint = networkConfig.archiveEndpoint) {
  ...
  fetchedActions.forEach((actionBlock) => {
    ...
    let latestActionState = Field5(actionBlock.actionState.actionStateTwo);
...
function createState() {
  return {
    ...
    get() {
      ...
      let stateFieldsType = Provable.Array(Field5, layout.length);
...
If none of these are the case, then please reach out on Discord at #zkapp-developers and/or open an issue to tell us!`);
        ...
        if (account.zkapp?.appState === void 0) {
          return Array(layout.length).fill(Field5(0));
        } else {
          let stateAsFields2 = [];
    ...
    async fetch() {
      ...
      let stateAsFields;
      if (account.zkapp?.appState === void 0) {
        stateAsFields = Array(layout.length).fill(Field5(0));
      } else {
        stateAsFields = [];
        for (let i2 = 0; i2 < layout.length; i2++) {
...
function method(target, methodName, descriptor) {
  ...
  let methodEntry = sortMethodArguments(ZkappClass.name, methodName, [PublicKey2, Field5, ...paramTypes], SelfProof2);
      ...
      try {
        if (inCompile() || inProver() || inAnalyze()) {
          ...
          try {
            ...
            let blindingValue = Provable.witness(Field5, getBlindingValue);
          ...
          let result;
          try {
            result = method2.apply(this, actualArgs.map((a, i2) => {
...
Note: Only types built out of \`Field\` are valid return types. This includes snarkyjs primitive types and custom CircuitValues.`;
      ...
      let { accountUpdate, result } = methodCallDepth === 0 ? AccountUpdate2.witness(returnType ?? provable2(null), runCalledContract, { skipCheck: true }) : runCalledContract();
...
function computeCallData(methodIntf, argumentValues, returnValue, blindingValue) {
  ...
  let argSizesAndFields = args.map(({ type, value }) => [
    Field5(type.sizeInFields()),
    ...type.toFields(value)
  ]);
  let totalArgSize = Field5(args.map(({ type }) => type.sizeInFields()).reduce((s, t) => s + t, 0));
  let totalArgFields = argSizesAndFields.flat();
  let returnSize = Field5(returnType?.sizeInFields() ?? 0);
...
var SmartContract = class {
  ...
  static Proof() {
    var _a2;
    let Contract = this;
    return _a2 = class extends Proof2 {
  ...
  constructor(address, tokenId) {
    ...
    Object.defineProperty(this, "reducer", {
      set(reducer) {
        var _a2;
        ((_a2 = this)._ ?? (_a2._ = {})).reducer = reducer;
      },
      get() {
  ...
  static async compile() {
    ...
    this.analyzeMethods();
    let { verificationKey: verificationKey_, provers, verify: verify2 } = await compileProgram(ZkappPublicInput, Empty, methodIntfs, methods, this);
    let verificationKey = {
      data: verificationKey_.data,
      hash: Field5(verificationKey_.hash)
    };
...
Try calling \`await ${this.constructor.name}.compile()\` first, this will cache the verification key in the background.`);
    ...
    let hash2 = typeof hash_ === "string" ? Field5(hash_) : hash_;
    ...
    (0, import_tslib4.__classPrivateFieldSet)(this, _SmartContract_executionState, {
      transactionId: (0, import_tslib4.__classPrivateFieldGet)(this, _SmartContract_executionState, "f").transactionId,
      accountUpdate
    }, "f");
...
`);
  ...
  init() {
    ...
    for (let i2 = 0; i2 < ZkappStateLength; i2++) {
      AccountUpdate2.setValue(accountUpdate.body.update.appState[i2], Field5(0));
    }
    AccountUpdate2.attachToTransaction(accountUpdate);
  }
  /**
  ...
  get self() {
    ...
    if (inSmartContract && inSmartContract.this === this) {
      ...
      (0, import_tslib4.__classPrivateFieldSet)(this, _SmartContract_executionState, { accountUpdate: accountUpdate2, transactionId }, "f");
      return accountUpdate2;
    }
    let executionState = (0, import_tslib4.__classPrivateFieldGet)(this, _SmartContract_executionState, "f");
    ...
    (0, import_tslib4.__classPrivateFieldSet)(this, _SmartContract_executionState, { transactionId, accountUpdate }, "f");
  ...
  get sender() {
    ...
    if ((0, import_tslib4.__classPrivateFieldGet)(this, _SmartContract__senderState, "f")?.transactionId === transactionId) {
      return (0, import_tslib4.__classPrivateFieldGet)(this, _SmartContract__senderState, "f").sender;
    } else {
      let sender2 = Provable.witness(PublicKey2, () => sender());
      (0, import_tslib4.__classPrivateFieldSet)(this, _SmartContract__senderState, { transactionId, sender: sender2 }, "f");
      return sender2;
    }
  }
  /**
  ...
  approve(updateOrCallback, layout) {
    let accountUpdate = updateOrCallback instanceof AccountUpdate2 ? updateOrCallback : Provable.witness(AccountUpdate2, () => updateOrCallback.accountUpdate);
...
class ${this.constructor.name} extends SmartContract {
  events = { 'my-event': Field }
    ...
    if (eventTypes.length === 1) {
      ...
      eventFields = [Field5(eventNumber), ...eventType.toFields(event)];
    }
  ...
  async fetchEvents(start = UInt322.from(0), end) {
    ...
    return events.map((eventData) => {
      if (sortedEventTypes.length === 1) {
        ...
        let event = this.events[type].fromFields(eventData.event.data.map((f) => Field5(f)));
        return {
          ...eventData,
          type,
          event: {
        ...
        let event = this.events[type].fromFields(eventProps.map((f) => Field5(f)));
        return {
          ...eventData,
          type,
          event: {
      ...
      try {
        for (let methodIntf of methodIntfs) {
          ...
          let { rows, digest, result, gates } = analyzeMethod(ZkappPublicInput, methodIntf, (publicInput, publicKey, tokenId, ...args) => {
            ...
            accountUpdate = (0, import_tslib4.__classPrivateFieldGet)(instance, _SmartContract_executionState, "f").accountUpdate;
            return result2;
          });
...
function getReducer(contract) {
  var _a2;
  let reducer = ((_a2 = contract)._ ?? (_a2._ = {})).reducer;
  if (reducer === void 0)
...
Use the optional \`maxTransactionsWithActions\` argument to increase this number.`);
      ...
      for (let i2 = 0; i2 < maxTransactionsWithActions; i2++) {
        ...
        let actionss = possibleActionsPerTransaction.map((n, i3) => {
          ...
          return Provable.witness(type, () => length === n ? actions : emptyValue2(type));
        });
        let eventsHashes = actionss.map((actions2) => {
          let events = actions2.map((a) => reducer.actionType.toFields(a));
          return Actions.hash(events);
        });
        let eventsHash = Provable.switch(lengths, Field5, eventsHashes);
    ...
    getActions(config) {
      ...
      Provable.asProver(() => {
        ...
        event.actions.map((action) => reducer.actionType.fromFields(action.map(Field5))));
      });
...
var VerificationKey2 = class extends Struct({
  ...provable2({ data: String, hash: Field5 }),
  toJSON({ data }) {
    return data;
  }
}) {
...
var Body = {
  ...
  keepAll(publicKey, tokenId, mayUseToken) {
    ...
    if (tokenId) {
      ...
      body.mayUseToken = Provable.if(tokenId.equals(TokenId3.default), AccountUpdate2.MayUseToken.type, AccountUpdate2.MayUseToken.No, AccountUpdate2.MayUseToken.ParentsOwnToken);
    }
    if (mayUseToken) {
...
var NetworkPrecondition = {
  ignoreAll() {
    let stakingEpochData = {
      ledger: { hash: ignore(Field5(0)), totalCurrency: ignore(uint64()) },
      seed: ignore(Field5(0)),
      startCheckpoint: ignore(Field5(0)),
      lockCheckpoint: ignore(Field5(0)),
      epochLength: ignore(uint32())
    };
    let nextEpochData = cloneCircuitValue(stakingEpochData);
    return {
      snarkedLedgerHash: ignore(Field5(0)),
...
var AccountPrecondition = {
  ignoreAll() {
    let appState = [];
    for (let i2 = 0; i2 < ZkappStateLength; ++i2) {
      appState.push(ignore(Field5(0)));
    }
    return {
      balance: ignore(uint64()),
      nonce: ignore(uint32()),
      receiptChainHash: ignore(Field5(0)),
...
var TokenId3 = {
  ...
  derive(tokenOwner, parentTokenId = Field5(1)) {
...
var Token = class {
  static getId(tokenOwner, parentTokenId = TokenId3.default) {
    return TokenId3.derive(tokenOwner, parentTokenId);
  }
  constructor({ tokenOwner, parentTokenId = TokenId3.default }) {
    this.parentTokenId = parentTokenId;
    this.tokenOwner = tokenOwner;
    try {
      this.id = TokenId3.derive(tokenOwner, parentTokenId);
    } catch (e) {
...
var CallForest = {
  ...
  hashChildren(update) {
    ...
    if (callsType.type === "Witness") {
      return Provable.witness(Field5, () => CallForest.hashChildrenBase(update));
    }
  ...
  addCallers(updates, context = {
    ...
    for (let update of updates) {
      ...
      let caller = Provable.if(mayUseToken.parentsOwnToken, context.self, Provable.if(mayUseToken.inheritFromParent, context.caller, TokenId3.default));
      let self = TokenId3.derive(update.body.publicKey, update.body.tokenId);
  ...
  computeCallerContext(update) {
    ...
    for (let update2 of ancestors) {
      ...
      context.self = TokenId3.derive(update2.body.publicKey, update2.body.tokenId);
    }
    return context;
  },
  callerContextType: provablePure({ self: Field5, caller: Field5 }),
...
var Authorization = {
  ...
  setProofAuthorizationKind({ body, id }, priorAccountUpdates) {
    ...
    let hash2 = Provable.witness(Field5, () => {
      ...
      try {
        ...
        return account.zkapp?.verificationKey?.hash ?? Field5(0);
      } catch {
        return Field5(0);
      }
    });
...
var ZkappPublicInput = provablePure({ accountUpdate: Field5, calls: Field5 }, { customObjectKeys: ["accountUpdate", "calls"] });
async function addMissingProofs(zkappCommand, { proofsEnabled = true }) {
  async function addProof(index, accountUpdate) {
    ...
    if (i2 === -1)
      throw Error(methodError2);
    let { proof } = await zkAppProver.run([accountUpdate.publicKey, accountUpdate.tokenId, ...args], { transaction: zkappCommand, accountUpdate, index }, async () => {
    ...
    async sendTransaction(txn) {
      ...
      txn.transaction.accountUpdates.forEach((p3, i2) => {
        ...
        if (p3.body.events.data.length > 0) {
          (_a2 = events[addr])[tokenId] ?? (_a2[tokenId] = []);
        ...
        let latestActionState = latestActionState_ !== void 0 ? Field5(latestActionState_) : Actions.emptyActionState();
...
function defaultNetworkState() {
  let epochData = {
    ledger: { hash: Field5(0), totalCurrency: UInt642.zero },
    seed: Field5(0),
    startCheckpoint: Field5(0),
    lockCheckpoint: Field5(0),
    epochLength: UInt322.zero
  };
  return {
    snarkedLedgerHash: Field5(0),
...
var Character = class extends CircuitValue {
  ...
  static fromString(str) {
    const char = Field5(str.charCodeAt(0));
...
(0, import_tslib5.__decorate)([
  prop,
  (0, import_tslib5.__metadata)("design:type", Field5)
...
var NullCharacter = () => new Character(Field5(0));
...
var MerkleTree = class {
  ...
  setNode(level, index, value) {
    var _a2;
    ((_a2 = this.nodes)[level] ?? (_a2[level] = {}))[index.toString()] = value;
  }
...
var BaseMerkleWitness = class extends CircuitValue {
  ...
  constructor(witness2) {
    ...
    this.isLeft = witness2.map((item) => Bool(item.isLeft));
  }
  /**
...
function MerkleWitness(height) {
  ...
  arrayProp(Field5, height - 1)(MerkleWitness_.prototype, "path");
...
var MerkleMapWitness = class extends CircuitValue {
  ...
  computeRootAndKey(value) {
    ...
    for (let i2 = 0; i2 < bits; i2++) {
      ...
      hash2 = Poseidon2.hash([left, right]);
      const bit = Provable.if(isLeft[i2], Field5(0), Field5(1));
