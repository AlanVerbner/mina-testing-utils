...
function assertAuthorizationKindValid(accountUpdate) {
  ...
  if (!isProved && verificationKeyHash !== 0n)
    throw Error(`Invalid authorization kind: If \`isProved\` is false, verification key hash must be 0, got ${verificationKeyHash}`);
}
...
var Authorization = {
  ...
  setLazySignature(accountUpdate, signature) {
    ...
    accountUpdate.body.authorizationKind.verificationKeyHash = Field4(0);
