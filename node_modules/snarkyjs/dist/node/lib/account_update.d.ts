...
export { smartContractContext, SetOrKeep, Permission, Preconditions, Body, Authorization, FeePayerUnsigned, ZkappCommand, addMissingSignatures, addMissingProofs, signJsonTransaction, ZkappStateLength, Events, Actions, TokenId, Token, CallForest, createChildAccountUpdate, AccountUpdatesLayout, zkAppProver, SmartContractContext, };
...
declare const TokenId: {
    ...
    derive(tokenOwner: PublicKey, parentTokenId?: import("./field.js").Field): import("./field.js").Field;
...
declare class AccountUpdate implements Types.AccountUpdate {
    ...
    static get MayUseToken(): {
        ...
        isNo({ body: { mayUseToken: { parentsOwnToken, inheritFromParent }, }, }: AccountUpdate): Bool;
