...
declare class Circuit {
     ...
     */
    static equal: {
        <T>(type: import("./circuit_value.js").FlexibleProvable<T>, x: T, y: T): import("../snarky.js").Bool;
        <T_1 extends {
            toFields(): import("./field.js").Field[];
        }>(x: T_1, y: T_1): import("../snarky.js").Bool;
    };
    /**
     * @deprecated use {@link Provable.if}
     */
    static if: {
        <T>(condition: import("../snarky.js").Bool, type: import("./circuit_value.js").FlexibleProvable<T>, x: T, y: T): T;
        <T_1 extends {
            toFields(): import("./field.js").Field[];
        }>(condition: import("../snarky.js").Bool, x: T_1, y: T_1): T_1;
    };
    /**
     * @deprecated use {@link Provable.switch}
     */
    static switch: <T, A extends import("./circuit_value.js").FlexibleProvable<T>>(mask: import("../snarky.js").Bool[], type: A, values: T[]) => T;
    /**
