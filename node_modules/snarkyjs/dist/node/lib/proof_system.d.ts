...
declare function compileProgram(publicInputType: ProvablePure<any>, publicOutputType: ProvablePure<any>, methodIntfs: MethodInterface[], methods: ((...args: any) => void)[], proofSystemTag: {
    ...
    verify: (statement: Pickles.Statement, proof: Pickles.Proof) => Promise<boolean>;
    tag: unknown;
}>;
...
declare function picklesRuleFromFunction(publicInputType: ProvablePure<any>, publicOutputType: ProvablePure<any>, func: (...args: unknown[]) => any, proofSystemTag: {
    name: string;
