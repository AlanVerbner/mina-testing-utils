...
declare class SmartContract {
    ...
    static compile(): Promise<{
        ...
        verify: (statement: Pickles.Statement, proof: unknown) => Promise<boolean>;
    }>;
    /**
    ...
    get token(): {
        ...
        mint({ address, amount, }: {
            address: Types.PublicKey | AccountUpdate | SmartContract;
        ...
        send({ from, to, amount, }: {
            from: Types.PublicKey | AccountUpdate | SmartContract;
            to: Types.PublicKey | AccountUpdate | SmartContract;
            amount: number | bigint | Types.UInt64;
        }): AccountUpdate;
    };
    /**
